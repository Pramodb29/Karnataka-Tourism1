...
<title>Karnataka Tour Places</title>
<style>
 body {
...
<div class="product-container">
    <%
        ...
        ArrayList<places> allPlaces = pdao.getallPlacesinfo();

        if (allPlaces != null && !allPlaces.isEmpty()) {
            for (places s : allPlaces) {
    %>
                <div class="product-card">
                    ...
                    <div class="content-wrapper">
                        ...
                        <ul class="details-list">
                           ...
                           <li><h4><b> <%= s.getPackage_name() %></b></h4></li>
                            <li><b>Places: <%= s.getSel_places() %></b></li>
				...
				<div
					...
					<a href="NewBooking.jsp?packageName=<%= s.getPackage_name() %>&image=<%= s.getImage() %>&places=<%= s.getSel_places() %>&duration=<%= s.getDuration() %>" 
                          class="add-to-cart">Book Now</a>
					

					<a href="dashboard.jsp" class="add-to-cart"
						style="background-color: #aa3f3fd4; width: 130px; text-align: center;">
						Back </a>
				</div>
