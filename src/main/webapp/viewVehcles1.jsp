...
<div class="product-container">
    <%
       VehicleDAO pdao = new VehicleDAOImpl();
        ArrayList<vehicle> allVehicles = pdao.getallVehiclesinfo();

        if (allVehicles != null && !allVehicles.isEmpty()) {
            for (vehicle s : allVehicles) {
    %>
                <div class="product-card">
					...
					<div class="user-button-container justify-content-between"
						...
						<div
							...
							<a href="NewBooking.jsp?vehicle=<%= s.getVehicle_type() %>&capacity=<%= s.getCapacity() %>&vehicleCost=<%= s.getCost_per_day() %>" 
